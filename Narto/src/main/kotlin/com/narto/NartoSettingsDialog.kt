...
object NartoSettingsDialog {
    ...
    fun show(context: Context, currentBaseUrl: String) {
        ...
        val cfButton = Button(context).apply {
            ...
            setOnClickListener {
                val target = normalizeNartoBase(input.text?.toString()) ?: currentBaseUrl
    ...
    private fun TextView.updateCf(url: String) {
        ...
        val has = NartoStore.loadCfCookie(host) != null || NartoStore.loadCfCookie(host.removePrefix("www.")) != null
    ...
    private fun showCfWebView(context: Context, url: String, onSaved: () -> Unit) {
        val webView = WebView(context).apply {
            ...
            settings.userAgentString = nartoHeaders()["User-Agent"]
